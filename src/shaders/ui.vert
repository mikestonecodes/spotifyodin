...
// One pipeline draws the whole UI: solid rects, rounded rects, glyphs and
// album art. What a vertex is depends on its texture index and radius, not on
// which pipeline or descriptor set is bound.

layout(push_constant) uniform Push {
	vec2 inv_screen; // 1 / framebuffer size, in pixels
} pc;
